...
# path_root <- 'C:/Users/David/Documents/Cursos.Seminarios/UCM/TFG/José Mar�???a González Aguilar - imbalanced Data'
...
# Lleva un tiempo aprender el paquete data.table, pero
# merece la pena. Es muy rápido y permite realizar 
# operaciones complejas de modo muy compacto
library(caret)
library(ranger)
library(tidyverse)
library(pROC)
...
####  :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::  ####
####                             CARGAR DATOS                              ####
# Es recomendable indicar la clase de los objetos mediante algún sufijo
dataENS.dt <- readRDS(file.path(path_data, "dataENS.dt.rds"))

# Es importante cerciorarse de que cada variable tenga la clase asignada correctamente
str(dataENS.dt)

## Como estamos trabajando con variables categóricas, el valor missing puede ser tratado como
## una categor????a más y tiene todo el sentido. Por ello, en lugar de eliminar estas variables y 
## perder información, es mejor sustituir estos valores NA por *
...
# No obstante, las unidades con valor true missing no son útiles para los modelos porque no
# podemos saber si existe un error en esta unidad o no, por tanto las suprimimos
dataENS.dt <- dataENS.dt[CNO_AS_true != '*']

# El grado de desagregación de las clasificaciones es importante. Vamos a realizar el análisis
# para los tres grados de desagregación de la CNO y para la variable derivada claseSocial. 
# Revisa las clasificaciones en el fichero Excel que contiene el diseño de registro de la encuesta
...
## NOTA: Ser�???a interesante definir en el conjunto de datos CNAE1_AS, CNAE2_AS y CNAE3_AS
## a partir de CNAE_AS como hemos hecho con CNO. En el fichero CodeManagement hay funciones 
## que permiten hacer esto fácilmente
...
for (iter in 1:nIter){
  ...
  ## NOTA: Nos interesa calcular las probabilidades de error para a su vez calcular
  ## el momento de error 
  ## ..............................  CNO1  .................................. ####
